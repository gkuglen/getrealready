...
const HOW_IT_WORKS = [
  {
    text: 'Share basic details about your property',
    icon: '/images/features/included/one.svg',
  },
  {
    text: 'Receive a structured analysis and recommendations',
    icon: '/images/features/included/two.svg',
  },
  {
    text: 'Review potential rent and performance upside',
    icon: '/images/features/included/three.svg',
  },
  {
    text: 'Decide if and how you want to move forward',
    icon: '/images/features/included/four.svg',
  },
];
        ...
        <div className="container mx-auto max-w-4xl px-0 md:px-6">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <article className="bg-tagline text-primary-foreground shadow-card rounded-[20px] p-7">
              ...
              <div className="border-primary-foreground/20 mt-6 border-t pt-5">
            ...
            <article className="bg-card border-border-light shadow-card rounded-[20px] border p-7">
              ...
              <ul className="mt-6 space-y-3">
                {[
                  ...
                  <li key={f} className="flex items-start gap-3">
                    <Check
                      className="text-tagline mt-0.5 size-4 shrink-0"
                      strokeWidth={2.5}
                    />
          ...
          <p className="text-muted-foreground mt-6 text-center text-xs leading-relaxed">
            Get Real Ready provides analysis, planning, and coordination
            support. We are not a licensed contractor and do not perform
            construction work directly. All work is completed by licensed
            third-party vendors.
          </p>
        </div>
      </section>
