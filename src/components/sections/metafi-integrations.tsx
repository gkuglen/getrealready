    ...
    <>
      ...
      <section id="grr-process" className="bg-background px-6 lg:px-0">
        <div className="container px-0 py-16 text-center sm:py-20 md:px-6 md:py-28">
          ...
          <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-base sm:text-lg">
            It adds up quickly. Most landlords don't need more complexity—they need a simple, reliable way to improve their units and move on.
          </p>
        </div>
      </section>
      ...
      <section id="grr-what-we-do" className="bg-background px-6 lg:px-0">
        <div className="container px-0 py-16 text-center sm:py-20 md:px-6 md:py-28">
          <p className="text-tagline mb-4 text-sm leading-tight sm:text-base">What We Do</p>
          <h2 className="text-foreground mx-auto max-w-3xl text-3xl leading-tight font-medium tracking-tight text-balance sm:text-4xl md:text-5xl">
            We focus on one thing: helping rental properties perform better.
          </h2>
          <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-base sm:text-lg">
            Most renovations improve appearance. We focus on what actually improves rent performance and long-term property value.
          </p>
          <ul className="text-muted-foreground mx-auto mt-6 max-w-xl space-y-2 text-base sm:text-lg">
      ...
      <section id="grr-why" className="bg-background px-6 lg:px-0">
        <div className="container px-0 py-16 text-center sm:py-20 md:px-6 md:py-28">
          <p className="text-tagline mb-4 text-sm leading-tight sm:text-base">Why Get Real Ready</p>
          <h2 className="text-foreground mx-auto max-w-3xl text-3xl leading-tight font-medium tracking-tight text-balance sm:text-4xl md:text-5xl">
            Built for Landlords. Backed by Data.
          </h2>
          <ul className="mx-auto mt-10 grid max-w-3xl gap-6 text-left sm:grid-cols-2">
            {[
              { title: 'Built for Landlords',       desc: 'We understand rent comps, cap rates, and how upgrades translate into value.' },
              { title: 'Data-Backed Decisions',     desc: 'Every recommendation is grounded in market data and real rent potential.' },
              { title: 'Standardized and Efficient',desc: 'Faster timelines, predictable costs, and consistent results across units.' },
              { title: 'One Partner',               desc: 'From analysis to renovation to maintenance—we handle it end-to-end.' },
            ].map((item) => (
              <li key={item.title} className="bg-accent rounded-[16px] p-6">
                <h3 className="text-foreground text-lg font-medium">{item.title}</h3>
                <p className="text-muted-foreground mt-2 text-base">{item.desc}</p>
              </li>
            ))}
          </ul>
          ...
          <div className="mx-auto mt-16 max-w-xl text-left">
            <p className="text-tagline mb-4 text-sm leading-tight sm:text-base text-center">Example ROI</p>
            <p className="text-muted-foreground mb-6 text-center text-base sm:text-lg">A simple way to think about it:</p>
            <ul className="bg-accent divide-border divide-y rounded-[16px] overflow-hidden">
              {[
                ...
                <li key={row.label} className="flex items-center justify-between px-6 py-4">
                  ...
                  <span className="text-foreground font-medium text-base">{row.value}</span>
                </li>
              ))}
            </ul>
